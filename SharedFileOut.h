...
typedef int PENALTY_SHORTCUT;
#define NONE 0
#define DriveThrough_Cutting 1
#define StopAndGo_10_Cutting 2
#define StopAndGo_20_Cutting 3
#define StopAndGo_30_Cutting 4
#define Disqualified_Cutting 5
#define RemoveBestLaptime_Cutting 6
#define DriveThrough_PitSpeeding 7
#define StopAndGo_10_PitSpeeding 8
#define StopAndGo_20_PitSpeeding 9
#define StopAndGo_30_PitSpeeding 10
#define Disqualified_PitSpeeding 11
#define RemoveBestLaptime_PitSpeeding 12
#define Disqualified_IgnoredMandatoryPit 13
#define PostRaceTime 14
#define Disqualified_Trolling 15
#define Disqualified_PitEntry 16
#define Disqualified_PitExit 17
#define Disqualified_WrongWay 18
#define DriveThrough_IgnoredDriverStint 19
#define Disqualified_IgnoredDriverStint 20
#define Disqualified_ExceededDriverStintLimit 21
...
struct SPageFileGraphic
{
    ...
    // flag and penalty currently not working
    AC_FLAG_TYPE flag;
    PENALTY_SHORTCUT penalty;
...
// Structs not implemented by dev
//    ACC_TRACK_GRIP_STATUS trackGripStatus = None;
//
//    ACC_RAIN_INTENSITY rainIntensity = None;
//    ACC_RAIN_INTENSITY rainIntensityIn30min = None;
//    ACC_RAIN_INTENSITY rainIntensityIn10min = None;
